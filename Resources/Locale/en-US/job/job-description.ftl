...
job-description-wosp = Protect this place using everything possible and impossible, otherwise the most dangerous inhabitants of the universe will break free.
job-description-ssp = Keeping the station safe from the criminal element is your highest mission on your shift, don't fail.
job-description-tsp = Service the prison, for escaped convicts will come after you first.
