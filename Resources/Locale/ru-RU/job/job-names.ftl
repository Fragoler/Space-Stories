...
job-name-warden-sp = Глава КТ
job-name-officer-sp = офицер КТ
job-name-technical-sp = техник КТ
...
JobBotanist = ботаник
JobCaptain = капитан
JobWardenSP = глава космической тюрьмы
JobOfficerSP = офицер КТ
JobTechnicalSP = техник КТ
